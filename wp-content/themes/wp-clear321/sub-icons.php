...
<?php if ( get_option('solostream_pinterest_url') ) { ?>
	<a title="<?php echo stripslashes(get_option('solostream_pinterest_link_text')); ?>" rel="external" href="http://www.pinterest.com/<?php echo stripslashes(get_option('solostream_pinterest_url')); ?>"><img class="pinterest-sub" src="<?php bloginfo('template_directory'); ?>/images/pinterest.png" alt="<?php echo stripslashes(get_option('solostream_pinterest_link_text')); ?>" align="top" /></a>
<?php } ?>
